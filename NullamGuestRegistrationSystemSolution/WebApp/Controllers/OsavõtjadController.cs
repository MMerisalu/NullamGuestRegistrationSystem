...
{
    public class OsavõtjadController : Controller
    {
        private readonly AppDbContext _context;

        public OsavõtjadController(AppDbContext context)
        {
            _context = context;
        }
